...
--
-- Host: 10.1.74.75    Database: life.apc
-- ------------------------------------------------------
...
f08e590a-ef8e-11ec-afcf-0242ac150005:1-1051';
...
--
-- Table structure for table `dim_charge`
--

DROP TABLE IF EXISTS `dim_charge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dim_charge` (
  `charge_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标识：free|pay',
  `charge_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '要价名：免费｜付费',
  PRIMARY KEY (`charge_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='应用要价。仅包两项，付费或免费';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dim_charge`
--

LOCK TABLES `dim_charge` WRITE;
/*!40000 ALTER TABLE `dim_charge` DISABLE KEYS */;
INSERT INTO `dim_charge` VALUES ('free','免费'),('pay','付费');
/*!40000 ALTER TABLE `dim_charge` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `dim_country` (
  `country_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标识',
  `cnname` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '中文名',
  `enname` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '英文名',
...
CREATE TABLE `fact_app` (
  ...
  `cate_id` varchar(50) NOT NULL COMMENT '类别标识',
  `terminal_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '终端标识',
  `charge_id` varchar(10) NOT NULL COMMENT '要价标识',
  ...
  `app_icon` varchar(250) NOT NULL,
  `newest_version` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最新版本号',
...
--
-- Table structure for table `purch_app_empl`
--

DROP TABLE IF EXISTS `purch_app_empl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `purch_app_empl` (
  `app_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '应用标识',
...
--
-- Dumping data for table `purch_app_empl`
--

LOCK TABLES `purch_app_empl` WRITE;
/*!40000 ALTER TABLE `purch_app_empl` DISABLE KEYS */;
/*!40000 ALTER TABLE `purch_app_empl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `purch_app_tenant`
--

DROP TABLE IF EXISTS `purch_app_tenant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `purch_app_tenant` (
  `app_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '应用标识',
...
--
-- Dumping data for table `purch_app_tenant`
--

LOCK TABLES `purch_app_tenant` WRITE;
/*!40000 ALTER TABLE `purch_app_tenant` DISABLE KEYS */;
/*!40000 ALTER TABLE `purch_app_tenant` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-25 19:30:49
